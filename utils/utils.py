...
def post_process_image(optimizing_img):
    """Convert the PyTorch tensor to a numpy array suitable for display"""
    ...
    # Add ImageNet mean (BGR order as per original VGG training)
